...
<body>
  ...
  <main>
    ...
    <p>*中等饱食度，高理智值，低生命值，初始低移速，中高攻击倍率</p>
    ...
    <ul>
      ...
      <li>【蕾缪安】可以<span class="color-important">读书</span>，但不能写书。【蕾缪安】消耗书的耐久减半，但消耗理智值增加为2.5倍。</li>
      ...
      <p>*天体装备：【亮茄头盔】，【启迪之冠】，【W.A.R.B.I.S.头戴齿轮】以及带<span class="color-important">天体阵营减伤</span>的装备。</p>
    ...
    <p>*精一解锁（冷却时间5s）</p>
    <ul>
      <li>蕾缪安手中持有狙时，默认按r周围出现玩家头像和64距离内敌人头像的指示标志。点击敌人头像时，对其发动2技能的蓄力锁定。</li>
      <li>点击玩家头像时，锁定对应玩家，周围出现跨境追击目标周围敌对生物的虚影，展示跨境追击目标与敌人的相对位置。虚影仅本人可见，无血量，除了蕾缪安本体以外其他人不可交互。自身技能发动时，对虚影造成的伤害会传导至对应目标。</li>
      <li>为避免敌人索敌混乱或者效果异常，<span class="color-important">虚影传递造成的伤害视为被观察的玩家造成。</span></li>
    </ul>
    <h5 id="ember-dance">2.逃犯引渡手续</h5>
    <p>*精二解锁</p>
    <ul>
      <li>1技能经过瞄准后，当次攻击击杀主目标且伤害溢出时，每颗子弹仅一次弹射至范围6内的最脆原则的敌人。</li>
    ...
    <p>*蕾缪安拥有技能ui，技能ui使用明日方舟内的贴图，每个技能ui右侧有对应技能的弹药槽。可右键进行拖动，默认键位B切换隐藏和显示。</p>
    ...
    <tbody>
        ...
        <tr>
          ...
          <td>弹药上限5/7，每10秒回复一颗弹药。
            ...
            <br><br>技能期间启用右键瞄准。
            <br>右键敌方目标时：鼠标指向目标按下r之后，蓄力6倍长予的攻击间隔后，消耗1发弹药，对瞄准目标造成800%的物理伤害，并对路径上的敌人造成300%伤害。
            <br>右键空地时，攻击间隔减少1倍长矛（为2倍长矛），自主选择射击角度，并对路径上的敌人造成150%/200%伤害。子弹达到最远时消失。
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>弹药上限8，每10秒回复一颗弹药。<br>
            ...
            消耗一枚弹药对鼠标位置进行一次轰炸，轰炸中心半径6范围距离内造成200%伤害，不摧毁建筑，可以炸死海洋或者池塘（绿洲和模组池塘无效）水中的鱼并掉落东西，半径4范围距离内改为造成400%伤害且摧毁建筑。<br>
            *技能拥有开采/砍/锤/铲的功能，锤铲可以通过点击3技能图标关闭。
          </td>
        </tr>
    </tbody>
    </table>
    ...
    <tbody>
        ...
        <tr>
          ...
          <td>所有人可以骑乘，骑乘时，将低于1的移速补足至1，再乘1.5倍。<br>
            【蕾缪安】骑乘时仅可以开启3技能。<br>
          </td>
        </tr>
